...
import { Phone, Mail, MapPin, MessageCircle, Menu, X, ShieldCheck, UserCheck, Facebook, Instagram, Video } from 'lucide-react';
    ...
    <header className="sticky top-0 z-40 bg-white/95 backdrop-blur-md shadow-sm border-b border-blue-100">
      ...
      <div className="bg-blue-950 text-white text-xs py-2 px-4 border-b border-blue-900">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-2">
          ...
          <div className="flex items-center gap-3 sm:gap-4 font-medium flex-wrap justify-center sm:justify-end">
            <a 
            ...
            >
              ...
              <span className="truncate max-w-[150px] lg:max-w-none">{SCHOOL_INFO.email}</span>
            </a>
            <span className="text-blue-700 hidden sm:inline">•</span>
            
            {/* Social Icons */}
            <div className="flex items-center gap-1.5 pl-1 border-l border-blue-800">
              <a
                href={SCHOOL_INFO.socialLinks.facebook}
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Facebook Page"
                title="Tofem on Facebook"
                className="p-1 hover:text-blue-400 transition-colors rounded hover:bg-blue-900"
              >
              ...
              <a
                ...
                title="Tofem on Instagram (@tofemschool)"
                className="p-1 hover:text-pink-400 transition-colors rounded hover:bg-blue-900"
              >
              ...
              <a
                ...
                title="Tofem on TikTok (@tofemschool)"
                className="p-1 hover:text-teal-300 transition-colors rounded hover:bg-blue-900 flex items-center gap-0.5"
              >
          ...
          <div className="pt-4 border-t border-slate-100 flex flex-col gap-2.5">
            ...
            <div className="pt-2 flex items-center justify-center gap-3">
              <a
                ...
                rel="noopener noreferrer"
                aria-label="Facebook"
                className="flex items-center gap-1.5 px-3 py-2 bg-blue-50 text-blue-900 text-xs font-bold rounded-lg border border-blue-200"
              >
              ...
              <a
                ...
                className="flex items-center gap-1.5 px-3 py-2 bg-pink-50 text-pink-900 text-xs font-bold rounded-lg border border-pink-200"
              >
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="TikTok"
                className="flex items-center gap-1.5 px-3 py-2 bg-slate-100 text-slate-900 text-xs font-bold rounded-lg border border-slate-300"
              >
